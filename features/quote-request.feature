Feature: Ask for a quote for a taxi ride
	...
	I need to be able to ask for quote
	...
	Scenario: Ask for quote for a route with origin and destination in served cities
	...
	Scenario: Ask for quote for a route with origin and destination not in served cities
